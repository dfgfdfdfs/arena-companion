...
$taskArgs += @('AccountSetup.cs','AccountSetupDialog.cs','ReplacementHandoff.cs') | ForEach-Object {Join-Path $taskBase $_}
$taskArgs += @('InstanceContext.cs','InstancePicker.cs','AccountReplacement.cs','MainForm.AccountReplacement.cs') | ForEach-Object {Join-Path $taskBase $_}
$taskArgs += @('Program.cs','MainForm.cs','MainForm.Control.cs','MainForm.TaskSettings.cs','RetryController.cs','BrowserScript.cs','ConversationRecovery.cs','WebPage.cs','AccountStore.cs','AuthPages.cs','AuthFlow.cs','ControlPipe.cs','TaskSettings.cs','AttachmentDialog.cs','AttachmentUpload.cs','CandidatePage.cs','CandidateStore.cs','CandidateCollector.cs','HtmlImageRenderer.cs','GalleryWindow.cs','ConversationWindow.cs','MainForm.Gallery.cs','SavedConversationStore.cs','SavedConversationWindow.cs') | ForEach-Object {Join-Path $taskBase $_}
